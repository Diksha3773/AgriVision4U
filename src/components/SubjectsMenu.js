                    ...
                    <div className='p-3'>
                        ...
                        <div className={"p-2 my-1 shadow rounded cursor-pointer " + (openacad ? 'bg-blue-200' : '')}>
                            ...
                            <div className={"z-10 my-2 border rounded-b-md max-h-max group-hover:block shadow-inner bg-white duration-500 " + (openacad ? '' : 'hidden')}>
                                ...
                                <div > <button className='flex border-[0.05px] justify-start w-full p-2 hover:bg-blue-100 active:translate-y-1 shadow-sm' onClick={() => { navigate("/Acadcord"); }}>Electrochemistry</button></div>
                                <div ><button className='flex border-[0.05px] justify-start w-full p-2 hover:bg-blue-100 active:translate-y-1 shadow-sm' onClick={() => { navigate("/Syllabus"); }}>P-Block Elements</button></div>
                                <div > <button className='flex border-[0.05px] justify-start w-full p-2 hover:bg-blue-100 active:translate-y-1 shadow-sm' onClick={() => { navigate("/Timetable"); }}>Surface Chemistry</button></div>
                                <div > <button className='flex border-[0.05px] justify-start w-full p-2 hover:bg-blue-100 active:translate-y-1 shadow-sm rounded-b-md' onClick={() => { }}>Chemical Kinetics</button></div>
                            </div>
                        </div>
                        <div className={"p-2 my-1 shadow rounded cursor-pointer " + (openpupil ? 'bg-blue-200' : '')}>
                            ...
                            <div className={"z-10 my-2 border rounded-b-md max-h-max group-hover:block shadow-inner bg-white duration-500 " + (openpupil ? '' : 'hidden h-0')}>
                                <div > <button className='flex border-[0.05px] justify-start w-full p-2 hover:bg-blue-100 active:translate-y-1 shadow-sm' onClick={() => { }}>Laws Of Motion</button></div>
                                <div > <button className='flex border-[0.05px] justify-start p-2 w-full   hover:bg-blue-100 active:translate-y-1 shadow-sm' onClick={() => { }}>Gravitation</button></div>
                                <div > <button className='flex border-[0.05px] justify-start p-2 w-full   hover:bg-blue-100 active:translate-y-1 shadow-sm' onClick={() => { }}>Motion in straight line</button></div>
                                <div > <button className='flex border-[0.05px] justify-start p-2 w-full   hover:bg-blue-100 active:translate-y-1 shadow-sm' onClick={() => { }}>Motion in Plane</button></div>
